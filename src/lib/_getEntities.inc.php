 ...
 *
 * @param $str {String}
 * @param $style {String} <smart|plain> default is 'smart'
 *
 * @return {String}
 */
function msWordEntities ($str, $style='smart') {
  ...
  if ($style === 'smart') { // replace w/ HTML entity equivalents
    $replace = [
      '&#8216;', '&#8217;', '&#8220;', '&#8221;', '&#8211;', '&#8212;', '&#8230;',
      '&#8216;', '&#8217;', '&#8220;', '&#8221;', '&#8211;', '&#8212;', '&#8230;',
      '&#8216;', '&#8217;', '&#8220;', '&#8221;', '&#8211;', '&#8212;', '&#8230;'
    ];
  } else { // replace w/ plain text equivalents
    $replace = [
      "'", "'", '"', '"', '--', '---', '...',
      "'", "'", '"', '"', '--', '---', '...',
      "'", "'", '"', '"', '--', '---', '...'
