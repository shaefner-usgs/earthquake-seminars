...
# Pretty URLs
RewriteRule ^{$CONFIG['MOUNT_PATH']}/archives/([0-9]{4})$ {$CONFIG['MOUNT_PATH']}/index.php?year=$1 [L,PT]
RewriteRule ^{$CONFIG['MOUNT_PATH']}/([0-9]+)$ {$CONFIG['MOUNT_PATH']}/seminar.php?id=$1 [L,PT]
